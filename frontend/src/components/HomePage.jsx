    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-5xl text-gray-900 mb-6">Build Your Resume with AI</h1>
            <p className="text-xl text-gray-600 mb-8">Simple, Smart and Fast AI-Powered Resume Builder.</p>
            <button
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Get intelligent suggestions for your skills, projects, and professional summary</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Create a professional resume in minutes with our intuitive builder</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Download your resume as a PDF and start applying immediately</p>
          </div>
        </motion.div>
      </section>

      {/* Footer Updated */}
      <footer className="w-full py-6 mt-20 mb-6 border-t border-gray-200 bg-blue-600">
